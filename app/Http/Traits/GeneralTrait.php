...
trait GeneralTrait
{
    ...
    public function responseErrorMessage($errorNumber, $message)
    {
    ...
    public function successMessage($number = 200, $message = "")
    {
        return [
            'status' => true,
            'number' => $number,
    ...
    public function responseSuccessData($key, $value, $message = "")
    {
        return response()->json([
            'status' => true,
            'number' => 200,
    ...
    public function validationError($code = "E001", $validator){
        return $this->responseErrorMessage($code, $validator->errors()->first());
    }
